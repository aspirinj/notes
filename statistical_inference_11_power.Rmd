...
## Power
Power is the probability of rejecting the null hypothesis when it is false. Ergo, power is a good thing; you want more power. A type II error is failing to reject the null hypothesis when it's false; the probability of a type II error is usually called $\beta$. Thus, Power is defined as $= 1 - \beta$.  


Consider our previous example involving RDI: $H_0: \mu = 30$ versus $H_a: \mu > 30$.  
Then power is:   
$$P\left(\frac{\bar X - 30}{s /\sqrt{n}} > t_{1-\alpha,n-1} ~;~ \mu = \mu_a \right)$$  
Note that this is a function that depends on the specific value of $\mu_a$. Notice as $\mu_a$ approaches $30$ the power approaches $\alpha$.  
