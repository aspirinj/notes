...
g <- ggplot(longGalton, aes(x = measurement)) + 
  geom_histogram(aes(y = ..density.., fill = person_attr), binwidth=1, color = "black") + 
  geom_density(size = 2) +
...
*Example:* Suppose that a die is rolled and $X$ is the number face up. What is the expected value of $X$?  
...
sim_count <- 10000; sample_size <- 10
df <- data.frame(
