...
Two types of errors:  
Truth | Decide | Result | Comments
---|---|---|---
$H_0$ | $H_a$ | Type I error | low standard, innocent people convicted
$H_a$ | $H_0$ | Type II error | high standard, guilty people let free
...
Hypothesis testing strategy would reject the null hypothesis if $\bar X$ was larger than constant $C$. Typically, $C$ is chosen so that $\alpha$, is $.05$ (or some other relevant constant).  
